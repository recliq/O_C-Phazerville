...
enum CALIBRATION_STEP {
  ...
  #ifdef VOR
  DAC_A_VOLT_MIN, DAC_A_VOLT_LOW, DAC_A_VOLT_HIGH,
  DAC_B_VOLT_MIN, DAC_B_VOLT_LOW, DAC_B_VOLT_HIGH,
  DAC_C_VOLT_MIN, DAC_C_VOLT_LOW, DAC_C_VOLT_HIGH,
  DAC_D_VOLT_MIN, DAC_D_VOLT_LOW, DAC_D_VOLT_HIGH,
  ...
  DAC_E_VOLT_MIN, DAC_E_VOLT_LOW, DAC_E_VOLT_HIGH,
  DAC_F_VOLT_MIN, DAC_F_VOLT_LOW, DAC_F_VOLT_HIGH,
  DAC_G_VOLT_MIN, DAC_G_VOLT_LOW, DAC_G_VOLT_HIGH,
  DAC_H_VOLT_MIN, DAC_H_VOLT_LOW, DAC_H_VOLT_HIGH,
#endif
  #endif
